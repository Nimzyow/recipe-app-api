...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test creatins aa user that already exists fails"""
    ...
    def test_password_too_short(self):
        """Test that the password myust be more than 5 characters"""
    ...
    def test_create_token_for_user(self):
        """test that a token is created for rthe user"""
        payload = {"email": "test@test.com", "password": "test123"}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload = {"email": "test@test.com", "password": "sowrong"}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_createtoken_missing_field(self):
